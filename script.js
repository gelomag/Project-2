...
// const genAI = new GoogleGenerativeAI(API_KEY); // **API KEY Hereeeee**
...
fetch("config.json")
  ...
  .then((config) => {
    API_KEY = config.API_KEY_1;
    import("https://esm.sh/@google/generative-ai").then((module) => {
      ...
      .then(config => {
          ...
          fetch(endpoint)
              ...
              .catch(error => {
                  ...
                  document.getElementById('diet-meals').innerHTML = "Error retrieving recipe data.";
              });
      })
      .catch(error => {
          console.error('Error fetching config:', error);
          document.getElementById('diet-meals').innerHTML = "Error retrieving configuration.";
      });
}
  ...
  fetch('config.json')
      ...
      .then(config => {
          ...
          fetch(endpoint)
              ...
              .catch(error => {
                  console.error('Error fetching recipe data:', error);
                  document.getElementById('random-meal').innerHTML = "Error retrieving recipe data.";
              });
      })
      .catch(error => {
          console.error('Error fetching config:', error);
          document.getElementById('random-meal').innerHTML = "Error retrieving configuration.";
      });
}
